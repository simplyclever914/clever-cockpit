...
The cockpit SHALL provide a dedicated Workflow view that explains how Ideas, Projects, Tasks, Approvals, and Activity relate.
...
- **THEN** the cockpit SHALL show a lifecycle map from idea capture through decision, draft project, task execution, and feedback
